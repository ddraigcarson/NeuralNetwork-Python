...
NETWORK_TRAINING_EPOCHS = 100
NETWORK_TRAINING_LOOPS = 50
NETWORK_TRAINING_SET_START = 0
NETWORK_TRAINING_SET_END = 15999
NETWORK_TESTING_SET_START = 50000
...
class Network:
    ...
    def __init__(self, layers, data_builder):
        self.layers = layers
...
file_reader = MnistFileReader()

network = Network(NETWORK_LAYERS, file_reader)
network.train()
network.test()
